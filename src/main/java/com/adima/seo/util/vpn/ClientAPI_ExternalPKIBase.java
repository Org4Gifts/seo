 ...
 */
package com.adima.seo.util.vpn;
...
public class ClientAPI_ExternalPKIBase {
    ...
    public boolean sign(String data, SWIGTYPE_p_std___string sig) {
        return ovpncliJNI.ClientAPI_ExternalPKIBase_sign(this.swigCPtr, this, data, SWIGTYPE_p_std___string.getCPtr(sig));
    }
}

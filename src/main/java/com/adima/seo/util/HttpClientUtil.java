...
public static String getHtmlBySearch(String url, int port, String encoding, String proxyHost, int proxyPort, String cookie)  
      throws HttpException, IOException {  
    HttpClient httpClient = getClient();  
    String rest = null;  
    if(proxyHost != null && proxyPort != 0) httpClient.getHostConfiguration().setProxy(proxyHost, proxyPort);  
...
//    String url = "http://blog.csdn.net/xmlrequest/article/details/11519503";  
    String url = "https://www.google.com.tw/search?q=adima"; 
//    String url = "http://www.google.com.tw/search?q=adima"; 
//    System.out.println(getHtml(url)); 
    String newUrl = new AnalyUrl().analyUrl(getHtml(url));
